object Versions {
    ...
    const val kotlinBindingCompiler = "3.2.0-alpha11"
    ...
    const val coroutineAndroidVersionJvm = "1.5.0"
    ...
    const val retrofitVersionRx = "2.9.0"
    ...
    const val androidTestRunnerVersion = "1.1.4"
