...
object Dependencies {
    ...
    object CoroutinesDep {
        ...
        const val coroutineCoreJvm =
            "org.jetbrains.kotlinx:kotlinx-coroutines-core-jvm:${Versions.coroutineAndroidVersionJvm}"
    ...
    const val kotlinBindingCompiler =
        "androidx.databinding:library:${Versions.kotlinBindingCompiler}"
